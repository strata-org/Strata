...
**Why it matters.** Closes the "PASS-? hides safe verdicts" gap (9 would-be-PASS programs) and surfaces the "PASS-? hides FAIL" gap (6 would-be-FAIL SV-COMP programs) as actual PARTIAL/FAIL verdicts. Combined with the just-landed multi-env work (`5648bdf62`), the matrix's deductive column would flip from 68 PASS / 15 PASS-? / 11 PARTIAL to roughly 78 PASS / 0 PASS-? / 17 PARTIAL — assuming the would-be-FAIL group surfaces as PARTIAL with concrete failing VCs.
