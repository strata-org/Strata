...
// via /usr/local/bin/smack --no-verify -bpl pointer_arith.bpl pointer_arith.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "pointer_arith.c", 5, 21} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "pointer_arith.c", 5, 21} true;
  assume {:verifier.code 0} true;
  call $p0 := malloc(12);
  assume {:sourceloc "pointer_arith.c", 5, 14} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  assume {:sourceloc "pointer_arith.c", 6, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1, $mul.ref(0, 4));
  assume {:sourceloc "pointer_arith.c", 6, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p2, 10);
  assume {:sourceloc "pointer_arith.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1, $mul.ref(1, 4));
  assume {:sourceloc "pointer_arith.c", 7, 10} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p3, 20);
  assume {:sourceloc "pointer_arith.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p1, $mul.ref(2, 4));
  assume {:sourceloc "pointer_arith.c", 8, 10} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i32($M.2, $p4, 30);
  assume {:sourceloc "pointer_arith.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1, $mul.ref(0, 4));
  assume {:sourceloc "pointer_arith.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.0, $p5);
  assume {:sourceloc "pointer_arith.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p1, $mul.ref(1, 4));
  assume {:sourceloc "pointer_arith.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.1, $p7);
  assume {:sourceloc "pointer_arith.c", 9, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i6, $i8);
  assume {:sourceloc "pointer_arith.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p1, $mul.ref(2, 4));
  assume {:sourceloc "pointer_arith.c", 9, 28} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i32($M.2, $p10);
  assume {:sourceloc "pointer_arith.c", 9, 26} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i9, $i11);
  assume {:sourceloc "pointer_arith.c", 9, 35} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12, 60);
  assume {:sourceloc "pointer_arith.c", 9, 35} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  assume {:sourceloc "pointer_arith.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i15 := assert_.i32($i14);
  assume {:sourceloc "pointer_arith.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $bitcast.ref.ref($p1);
  assume {:sourceloc "pointer_arith.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call free_($p16);
  assume {:sourceloc "pointer_arith.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
