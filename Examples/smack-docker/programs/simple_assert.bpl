...
// via /usr/local/bin/smack --no-verify -bpl simple_assert.bpl simple_assert.c
...
const add: ref;
axiom (add == $sub.ref(0, 1032));
procedure  add($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i32;
$bb0:
  assume {:sourceloc "simple_assert.c", 4, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "add:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "add:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "simple_assert.c", 4, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $i1);
  assume {:sourceloc "simple_assert.c", 4, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "simple_assert.c", 8, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "simple_assert.c", 9, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 7);
  assume {:sourceloc "simple_assert.c", 9, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "simple_assert.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := assert_.i32($i2);
  assume {:sourceloc "simple_assert.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.dbg.value == $sub.ref(0, 20640));
