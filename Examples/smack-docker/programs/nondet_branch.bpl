...
// via /usr/local/bin/smack --no-verify -bpl nondet_branch.bpl nondet_branch.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "nondet_branch.c", 4, 11} true;
  ...
  assume {:sourceloc "nondet_branch.c", 5, 3} true;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "nondet_branch.c", 7, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 50);
  assume {:sourceloc "nondet_branch.c", 7, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb9, $bb10;
$bb9:
  assume ($i3 == 1);
  assume {:sourceloc "nondet_branch.c", 8, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i0, 50);
  call {:cexpr "y"} boogie_si_record_i32($i4);
  assume {:sourceloc "nondet_branch.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb11;
$bb10:
  ...
  goto $bb11;
$bb11:
  assume {:sourceloc "nondet_branch.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "nondet_branch.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $sge.i32($i5, 50);
  assume {:sourceloc "nondet_branch.c", 12, 18} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
...
$bb12:
  assume ($i6 == 1);
  assume {:sourceloc "nondet_branch.c", 12, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $sle.i32($i5, 100);
  assume {:verifier.code 0} true;
  $i7 := $i8;
...
$bb14:
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i7);
  assume {:sourceloc "nondet_branch.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := assert_.i32($i9);
  assume {:sourceloc "nondet_branch.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 3096));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 4128));
...
axiom (__SMACK_dummy == $sub.ref(0, 5160));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 15480));
