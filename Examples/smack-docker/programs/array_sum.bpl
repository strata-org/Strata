...
// via /usr/local/bin/smack --no-verify -bpl array_sum.bpl array_sum.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 23744));
...
const {:allocSize 16} {:count 4} __const.main.a: ref;
axiom (__const.main.a == $sub.ref(0, 1040));
const main: ref;
axiom (main == $sub.ref(0, 2072));
...
$bb0:
  call $initialize();
  assume {:sourceloc "array_sum.c", 4, 7} true;
  ...
  assume {:sourceloc "array_sum.c", 4, 7} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.0, $p1, __const.main.a, 16, false);
  assume {:sourceloc "array_sum.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "array_sum.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "array_sum.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "array_sum.c", 6, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, 4);
  assume {:sourceloc "array_sum.c", 6, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "array_sum.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.i32.i64($i3);
  assume {:sourceloc "array_sum.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref($i5, 4));
  assume {:sourceloc "array_sum.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i32($M.1, $p6);
  assume {:sourceloc "array_sum.c", 7, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i2, $i7);
  call {:cexpr "sum"} boogie_si_record_i32($i8);
  assume {:sourceloc "array_sum.c", 8, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "array_sum.c", 9, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i2, 10);
  assume {:sourceloc "array_sum.c", 9, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "array_sum.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := assert_.i32($i11);
  assume {:sourceloc "array_sum.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "array_sum.c", 6, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i3, 1);
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 4136));
procedure  llvm.memcpy.p0i8.p0i8.i64($p0: ref, $p1: ref, $i2: i64, $i3: i1);
const assert_: ref;
axiom (assert_ == $sub.ref(0, 5168));
procedure  assert_.i32(p.0: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 6200));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 7232));
...
axiom (__SMACK_dummy == $sub.ref(0, 8264));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 18584));
...
axiom (__SMACK_decls == $sub.ref(0, 19616));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 20648));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 21680));
...
{
$bb0:
  $M.0 := $store.i32($M.0, __const.main.a, 1);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(__const.main.a, $mul.ref(0, 16)), $mul.ref(1, 4)), 2);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(__const.main.a, $mul.ref(0, 16)), $mul.ref(2, 4)), 3);
  $M.0 := $store.i32($M.0, $add.ref($add.ref(__const.main.a, $mul.ref(0, 16)), $mul.ref(3, 4)), 4);
  $exn := false;
  return;
}
