...
// via /usr/local/bin/smack --no-verify -bpl aws_ring_buffer.bpl aws_ring_buffer.c
...
const ring_buffer_used: ref;
axiom (ring_buffer_used == $sub.ref(0, 1032));
procedure  ring_buffer_used($p0: ref)
  returns ($r: i64)
{
  var $p1: ref;
  var $i2: i64;
  ...
  var $i11: i64;
$bb0:
  assume {:sourceloc "aws_ring_buffer.c", 15, 11} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.0, $p1);
  assume {:sourceloc "aws_ring_buffer.c", 15, 23} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 15, 23} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.1, $p3);
  assume {:sourceloc "aws_ring_buffer.c", 15, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i2, $i4);
  assume {:sourceloc "aws_ring_buffer.c", 15, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "aws_ring_buffer.c", 16, 16} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "aws_ring_buffer.c", 16, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i64($M.0, $p6);
  assume {:sourceloc "aws_ring_buffer.c", 16, 27} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 16, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i64($M.1, $p8);
  assume {:sourceloc "aws_ring_buffer.c", 16, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.i64($i7, $i9);
  assume {:sourceloc "aws_ring_buffer.c", 16, 5} true;
  assume {:verifier.code 0} true;
  $i11 := $i10;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "aws_ring_buffer.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "aws_ring_buffer.c", 18, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.2, $p12);
  assume {:sourceloc "aws_ring_buffer.c", 18, 31} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 18, 31} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i64($M.1, $p14);
  assume {:sourceloc "aws_ring_buffer.c", 18, 25} true;
  assume {:verifier.code 0} true;
  $i16 := $sub.i64($i13, $i15);
  assume {:sourceloc "aws_ring_buffer.c", 18, 42} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "aws_ring_buffer.c", 18, 42} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i64($M.0, $p17);
  assume {:sourceloc "aws_ring_buffer.c", 18, 36} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i64($i16, $i18);
  assume {:sourceloc "aws_ring_buffer.c", 18, 5} true;
  assume {:verifier.code 0} true;
  $i11 := $i19;
  goto $bb3;
$bb3:
  assume {:sourceloc "aws_ring_buffer.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "aws_ring_buffer.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $exn := false;
  return;
...
const ring_buffer_free: ref;
axiom (ring_buffer_free == $sub.ref(0, 3096));
procedure  ring_buffer_free($p0: ref)
  returns ($r: i64)
{
  var $p1: ref;
  var $i2: i64;
  ...
  var $i5: i64;
$bb0:
  assume {:sourceloc "aws_ring_buffer.c", 22, 14} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "aws_ring_buffer.c", 22, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.i64($M.2, $p1);
  assume {:sourceloc "aws_ring_buffer.c", 22, 25} true;
  assume {:verifier.code 0} true;
  call $i3 := ring_buffer_used($p0);
  assume {:sourceloc "aws_ring_buffer.c", 22, 23} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i64($i2, $i3);
  assume {:sourceloc "aws_ring_buffer.c", 22, 46} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i64($i4, 1);
  assume {:sourceloc "aws_ring_buffer.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "aws_ring_buffer.c", 28, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "aws_ring_buffer.c", 28, 6} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(0, 1));
  assume {:sourceloc "aws_ring_buffer.c", 28, 10} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.ref($M.3, $p3, $p0);
  assume {:sourceloc "aws_ring_buffer.c", 29, 6} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(8, 1));
  assume {:sourceloc "aws_ring_buffer.c", 29, 15} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.i64($M.2, $p4, 8);
  assume {:sourceloc "aws_ring_buffer.c", 30, 6} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "aws_ring_buffer.c", 30, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p5, 0);
  assume {:sourceloc "aws_ring_buffer.c", 31, 6} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 31, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i64($M.1, $p6, 0);
  assume {:sourceloc "aws_ring_buffer.c", 34, 10} true;
  assume {:verifier.code 0} true;
  call $i7 := ring_buffer_used($p1);
  assume {:sourceloc "aws_ring_buffer.c", 34, 32} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i64($i7, 0);
  assume {:sourceloc "aws_ring_buffer.c", 34, 32} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "aws_ring_buffer.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call $i10 := assert_.i32($i9);
  assume {:sourceloc "aws_ring_buffer.c", 35, 10} true;
  assume {:verifier.code 0} true;
  call $i11 := ring_buffer_free($p1);
  assume {:sourceloc "aws_ring_buffer.c", 35, 32} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i64($i11, 7);
  assume {:sourceloc "aws_ring_buffer.c", 35, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i1.i32($i12);
  assume {:sourceloc "aws_ring_buffer.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i14 := assert_.i32($i13);
  assume {:sourceloc "aws_ring_buffer.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "aws_ring_buffer.c", 38, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p15, 3);
  assume {:sourceloc "aws_ring_buffer.c", 39, 10} true;
  assume {:verifier.code 0} true;
  call $i16 := ring_buffer_used($p1);
  assume {:sourceloc "aws_ring_buffer.c", 39, 32} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i64($i16, 3);
  assume {:sourceloc "aws_ring_buffer.c", 39, 32} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i1.i32($i17);
  assume {:sourceloc "aws_ring_buffer.c", 39, 3} true;
  assume {:verifier.code 0} true;
  call $i19 := assert_.i32($i18);
  assume {:sourceloc "aws_ring_buffer.c", 40, 10} true;
  assume {:verifier.code 0} true;
  call $i20 := ring_buffer_free($p1);
  assume {:sourceloc "aws_ring_buffer.c", 40, 32} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i64($i20, 4);
  assume {:sourceloc "aws_ring_buffer.c", 40, 32} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i1.i32($i21);
  assume {:sourceloc "aws_ring_buffer.c", 40, 3} true;
  assume {:verifier.code 0} true;
  call $i23 := assert_.i32($i22);
  assume {:sourceloc "aws_ring_buffer.c", 43, 6} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 43, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i64($M.1, $p24, 2);
  assume {:sourceloc "aws_ring_buffer.c", 44, 10} true;
  assume {:verifier.code 0} true;
  call $i25 := ring_buffer_used($p1);
  assume {:sourceloc "aws_ring_buffer.c", 44, 32} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.i64($i25, 1);
  assume {:sourceloc "aws_ring_buffer.c", 44, 32} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i32($i26);
  assume {:sourceloc "aws_ring_buffer.c", 44, 3} true;
  assume {:verifier.code 0} true;
  call $i28 := assert_.i32($i27);
  assume {:sourceloc "aws_ring_buffer.c", 45, 10} true;
  assume {:verifier.code 0} true;
  call $i29 := ring_buffer_free($p1);
  assume {:sourceloc "aws_ring_buffer.c", 45, 32} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i64($i29, 6);
  assume {:sourceloc "aws_ring_buffer.c", 45, 32} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i1.i32($i30);
  assume {:sourceloc "aws_ring_buffer.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call $i32 := assert_.i32($i31);
  assume {:sourceloc "aws_ring_buffer.c", 48, 6} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(16, 1));
  assume {:sourceloc "aws_ring_buffer.c", 48, 11} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p33, 1);
  assume {:sourceloc "aws_ring_buffer.c", 49, 6} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p1, $mul.ref(0, 32)), $mul.ref(24, 1));
  assume {:sourceloc "aws_ring_buffer.c", 49, 11} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i64($M.1, $p34, 6);
  assume {:sourceloc "aws_ring_buffer.c", 50, 10} true;
  assume {:verifier.code 0} true;
  call $i35 := ring_buffer_used($p1);
  assume {:sourceloc "aws_ring_buffer.c", 50, 32} true;
  assume {:verifier.code 0} true;
  $i36 := $eq.i64($i35, 3);
  assume {:sourceloc "aws_ring_buffer.c", 50, 32} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i1.i32($i36);
  assume {:sourceloc "aws_ring_buffer.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $i38 := assert_.i32($i37);
  assume {:sourceloc "aws_ring_buffer.c", 51, 10} true;
  assume {:verifier.code 0} true;
  call $i39 := ring_buffer_free($p1);
  assume {:sourceloc "aws_ring_buffer.c", 51, 32} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i64($i39, 4);
  assume {:sourceloc "aws_ring_buffer.c", 51, 32} true;
  assume {:verifier.code 0} true;
  $i41 := $zext.i1.i32($i40);
  assume {:sourceloc "aws_ring_buffer.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call $i42 := assert_.i32($i41);
  assume {:sourceloc "aws_ring_buffer.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
