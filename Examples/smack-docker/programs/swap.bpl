...
// via /usr/local/bin/smack --no-verify -bpl swap.bpl swap.c
...
const swap: ref;
axiom (swap == $sub.ref(0, 1032));
procedure  swap($p0: ref, $p1: ref)
{
  var $i2: i32;
  var $i3: i32;
$bb0:
  assume {:sourceloc "swap.c", 4, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "swap.c", 4, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p0);
  call {:cexpr "tmp"} boogie_si_record_i32($i2);
  assume {:sourceloc "swap.c", 5, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.1, $p1);
  assume {:sourceloc "swap.c", 5, 6} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, $i3);
  assume {:sourceloc "swap.c", 6, 6} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, $i2);
  assume {:sourceloc "swap.c", 7, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "swap.c", 10, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "swap.c", 10, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i32($M.0, $p0, 5);
  assume true;
  assume {:sourceloc "swap.c", 10, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.i32($M.1, $p1, 10);
  assume {:sourceloc "swap.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call swap($p0, $p1);
  assume {:sourceloc "swap.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p0);
  assume {:sourceloc "swap.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 10);
  assume {:sourceloc "swap.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  assume {:sourceloc "swap.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i5 := assert_.i32($i4);
  assume {:sourceloc "swap.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i32($M.1, $p1);
  assume {:sourceloc "swap.c", 13, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 5);
  assume {:sourceloc "swap.c", 13, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i1.i32($i7);
  assume {:sourceloc "swap.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call $i9 := assert_.i32($i8);
  assume {:sourceloc "swap.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
