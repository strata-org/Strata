...
// via /usr/local/bin/smack --no-verify -bpl aws_array_eq.bpl aws_array_eq.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 26820));
...
const {:allocSize 4} {:count 4} __const.main.a: ref;
axiom (__const.main.a == $sub.ref(0, 1028));
const {:allocSize 4} {:count 4} __const.main.b: ref;
axiom (__const.main.b == $sub.ref(0, 2056));
const {:allocSize 4} {:count 4} __const.main.c: ref;
axiom (__const.main.c == $sub.ref(0, 3084));
const aws_array_eq: ref;
axiom (aws_array_eq == $sub.ref(0, 4116));
procedure  aws_array_eq($p0: ref, $i1: i64, $p2: ref, $i3: i64)
  returns ($r: i1)
{
  var $i4: i1;
  var $i6: i64;
  ...
  var $i5: i1;
$bb0:
  assume {:sourceloc "aws_array_eq.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "aws_array_eq:arg:a_len"} boogie_si_record_i64($i1);
  call {:cexpr "aws_array_eq:arg:b_len"} boogie_si_record_i64($i3);
  assume {:sourceloc "aws_array_eq.c", 8, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $ne.i64($i1, $i3);
  assume {:sourceloc "aws_array_eq.c", 8, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "aws_array_eq.c", 8, 23} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "aws_array_eq.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i6 := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "aws_array_eq.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "aws_array_eq.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "aws_array_eq.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "aws_array_eq.c", 11, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.i64($i6, $i1);
  assume {:sourceloc "aws_array_eq.c", 11, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i7 == 1);
  assume {:sourceloc "aws_array_eq.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0, $mul.ref($i6, 1));
  assume {:sourceloc "aws_array_eq.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p8);
  assume {:sourceloc "aws_array_eq.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  assume {:sourceloc "aws_array_eq.c", 12, 23} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p2, $mul.ref($i6, 1));
  assume {:sourceloc "aws_array_eq.c", 12, 23} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.1, $p11);
  assume {:sourceloc "aws_array_eq.c", 12, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i12);
  assume {:sourceloc "aws_array_eq.c", 12, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i10, $i13);
  assume {:sourceloc "aws_array_eq.c", 12, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "aws_array_eq.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
  goto $bb3;
$bb7:
  assume ($i14 == 1);
  assume {:sourceloc "aws_array_eq.c", 12, 35} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
$bb8:
  assume !(($i14 == 1));
  assume {:sourceloc "aws_array_eq.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "aws_array_eq.c", 11, 34} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i6, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "aws_array_eq.c", 18, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "aws_array_eq.c", 18, 11} true;
  assume {:verifier.code 0} true;
  call $M.0 := $memcpy.i8($M.0, $M.2, $p3, __const.main.a, 4, false);
  assume true;
  assume {:sourceloc "aws_array_eq.c", 19, 11} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p1);
  assume {:sourceloc "aws_array_eq.c", 19, 11} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.3, $p4, __const.main.b, 4, false);
  assume true;
  assume {:sourceloc "aws_array_eq.c", 20, 11} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p2);
  assume {:sourceloc "aws_array_eq.c", 20, 11} true;
  assume {:verifier.code 0} true;
  call $M.1 := $memcpy.i8($M.1, $M.4, $p5, __const.main.c, 4, false);
  assume {:sourceloc "aws_array_eq.c", 22, 23} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 22, 29} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 22, 10} true;
  assume {:verifier.code 0} true;
  call $i8 := aws_array_eq($p6, 4, $p7, 4);
  assume {:sourceloc "aws_array_eq.c", 22, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i1.i32($i8);
  assume {:sourceloc "aws_array_eq.c", 22, 35} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 1);
  assume {:sourceloc "aws_array_eq.c", 22, 35} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  assume {:sourceloc "aws_array_eq.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call $i12 := assert_.i32($i11);
  assume {:sourceloc "aws_array_eq.c", 23, 23} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 23, 29} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p2, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 23, 10} true;
  assume {:verifier.code 0} true;
  call $i15 := aws_array_eq($p13, 4, $p14, 4);
  assume {:sourceloc "aws_array_eq.c", 23, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  assume {:sourceloc "aws_array_eq.c", 23, 35} true;
  assume {:verifier.code 0} true;
  $i17 := $eq.i32($i16, 0);
  assume {:sourceloc "aws_array_eq.c", 23, 35} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i1.i32($i17);
  assume {:sourceloc "aws_array_eq.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call $i19 := assert_.i32($i18);
  assume {:sourceloc "aws_array_eq.c", 24, 23} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 24, 29} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p1, $mul.ref(0, 4)), $mul.ref(0, 1));
  assume {:sourceloc "aws_array_eq.c", 24, 10} true;
  assume {:verifier.code 0} true;
  call $i22 := aws_array_eq($p20, 4, $p21, 3);
  assume {:sourceloc "aws_array_eq.c", 24, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  assume {:sourceloc "aws_array_eq.c", 24, 35} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.i32($i23, 0);
  assume {:sourceloc "aws_array_eq.c", 24, 35} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i1.i32($i24);
  assume {:sourceloc "aws_array_eq.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call $i26 := assert_.i32($i25);
  assume {:sourceloc "aws_array_eq.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 7212));
procedure  llvm.memcpy.p0i8.p0i8.i64($p0: ref, $p1: ref, $i2: i64, $i3: i1);
const assert_: ref;
axiom (assert_ == $sub.ref(0, 8244));
procedure  assert_.i32(p.0: i32)
  returns ($r: i32);
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 9276));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __VERIFIER_assume: ref;
axiom (__VERIFIER_assume == $sub.ref(0, 10308));
...
axiom (__SMACK_dummy == $sub.ref(0, 11340));
...
axiom (__SMACK_and32 == $sub.ref(0, 12372));
...
axiom (__SMACK_and64 == $sub.ref(0, 13404));
...
axiom (__SMACK_and16 == $sub.ref(0, 14436));
...
axiom (__SMACK_and8 == $sub.ref(0, 15468));
...
axiom (__SMACK_or32 == $sub.ref(0, 16500));
...
axiom (__SMACK_or64 == $sub.ref(0, 17532));
...
axiom (__SMACK_or16 == $sub.ref(0, 18564));
...
axiom (__SMACK_or8 == $sub.ref(0, 19596));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20628));
...
axiom (__SMACK_loop_exit == $sub.ref(0, 21660));
...
axiom (__SMACK_decls == $sub.ref(0, 22692));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 23724));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 24756));
...
axiom (llvm.dbg.value == $sub.ref(0, 25788));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 26820));
procedure  __SMACK_static_init()
{
$bb0:
  $M.2 := $store.i8($M.2, __const.main.a, 1);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.a, $mul.ref(0, 4)), $mul.ref(1, 1)), 2);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.a, $mul.ref(0, 4)), $mul.ref(2, 1)), 3);
  $M.2 := $store.i8($M.2, $add.ref($add.ref(__const.main.a, $mul.ref(0, 4)), $mul.ref(3, 1)), 4);
  $M.3 := $store.i8($M.3, __const.main.b, 1);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.main.b, $mul.ref(0, 4)), $mul.ref(1, 1)), 2);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.main.b, $mul.ref(0, 4)), $mul.ref(2, 1)), 3);
  $M.3 := $store.i8($M.3, $add.ref($add.ref(__const.main.b, $mul.ref(0, 4)), $mul.ref(3, 1)), 4);
  $M.4 := $store.i8($M.4, __const.main.c, 1);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.c, $mul.ref(0, 4)), $mul.ref(1, 1)), 2);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.c, $mul.ref(0, 4)), $mul.ref(2, 1)), 3);
  $M.4 := $store.i8($M.4, $add.ref($add.ref(__const.main.c, $mul.ref(0, 4)), $mul.ref(3, 1)), 5);
  $exn := false;
  return;
}
