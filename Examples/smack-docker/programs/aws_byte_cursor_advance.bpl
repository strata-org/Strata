...
// via /usr/local/bin/smack --no-verify -bpl aws_byte_cursor_advance.bpl aws_byte_cursor_advance.c
...
const aws_byte_cursor_advance: ref;
axiom (aws_byte_cursor_advance == $sub.ref(0, 1032));
procedure  aws_byte_cursor_advance($p0: ref, $i1: i64)
  returns ($r: ref)
{
  var $p2: ref;
  var $p3: ref;
  ...
  var $p24: ref;
$bb0:
  assume {:sourceloc "aws_byte_cursor_advance.c", 16, 15} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(16, $zext.i32.i64(1)));
  call {:cexpr "aws_byte_cursor_advance:arg:len"} boogie_si_record_i64($i1);
  assume true;
  assume {:sourceloc "aws_byte_cursor_advance.c", 16, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.i64($M.0, $p3);
  assume {:sourceloc "aws_byte_cursor_advance.c", 16, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $uge.i64($i4, $i1);
  assume {:sourceloc "aws_byte_cursor_advance.c", 16, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "aws_byte_cursor_advance.c", 17, 22} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 17, 22} true;
  assume {:verifier.code 0} true;
  $p7 := $load.ref($M.1, $p6);
  assume {:sourceloc "aws_byte_cursor_advance.c", 17, 8} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 17, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p8, $p7);
  assume {:sourceloc "aws_byte_cursor_advance.c", 18, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i64($M.3, $p9, $i1);
  assume {:sourceloc "aws_byte_cursor_advance.c", 19, 13} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 19, 17} true;
  assume {:verifier.code 0} true;
  $p11 := $load.ref($M.1, $p10);
  assume {:sourceloc "aws_byte_cursor_advance.c", 19, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p11, $mul.ref($i1, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 19, 17} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p10, $p12);
  assume {:sourceloc "aws_byte_cursor_advance.c", 20, 13} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 20, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "aws_byte_cursor_advance.c", 20, 17} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p13, $i15);
  assume {:sourceloc "aws_byte_cursor_advance.c", 21, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !(($i5 == 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 22, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 22, 12} true;
  assume {:verifier.code 0} true;
  $M.2 := $store.ref($M.2, $p16, $0.ref);
  assume {:sourceloc "aws_byte_cursor_advance.c", 23, 8} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 23, 12} true;
  assume {:verifier.code 0} true;
  $M.3 := $store.i64($M.3, $p17, 0);
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  assume ($extractvalue.ref($p21, 1) == $extractvalue.ref($u0, 1));
  assume ($extractvalue.i64($p21, 0) == $i20);
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  $p22 := $add.ref($add.ref($p18, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  $p23 := $load.ref($M.2, $p22);
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  assume ($extractvalue.i64($p24, 0) == $extractvalue.i64($p21, 0));
  assume ($extractvalue.ref($p24, 1) == $p23);
  assume {:sourceloc "aws_byte_cursor_advance.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $r := $p24;
  $exn := false;
...
$bb0:
  call $initialize();
  assume {:sourceloc "aws_byte_cursor_advance.c", 31, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 31, 14} true;
  assume {:verifier.code 0} true;
  $M.1 := $store.ref($M.1, $p4, $p0);
  assume {:sourceloc "aws_byte_cursor_advance.c", 32, 10} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 32, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, $p5, 16);
  assume true;
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  call $p6 := aws_byte_cursor_advance($p1, 4);
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  $i9 := $extractvalue.i64($p6, 0);
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  $M.4 := $store.i64($M.4, $p8, $i9);
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p7, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  $p11 := $extractvalue.ref($p6, 1);
  assume {:sourceloc "aws_byte_cursor_advance.c", 34, 34} true;
  assume {:verifier.code 0} true;
  $M.5 := $store.ref($M.5, $p10, $p11);
  assume {:sourceloc "aws_byte_cursor_advance.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i64($M.4, $p12);
  assume {:sourceloc "aws_byte_cursor_advance.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i64($i13, 4);
  assume {:sourceloc "aws_byte_cursor_advance.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "aws_byte_cursor_advance.c", 35, 3} true;
  assume {:verifier.code 0} true;
  call $i16 := assert_.i32($i15);
  assume {:sourceloc "aws_byte_cursor_advance.c", 36, 17} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 36, 17} true;
  assume {:verifier.code 0} true;
  $i18 := $load.i64($M.0, $p17);
  assume {:sourceloc "aws_byte_cursor_advance.c", 36, 21} true;
  assume {:verifier.code 0} true;
  $i19 := $eq.i64($i18, 12);
  assume {:sourceloc "aws_byte_cursor_advance.c", 36, 21} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i32($i19);
  assume {:sourceloc "aws_byte_cursor_advance.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call $i21 := assert_.i32($i20);
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p2, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 16} true;
  assume {:verifier.code 0} true;
  $p23 := $load.ref($M.5, $p22);
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 23} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $eq.ref($p23, $p24);
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i1.i32($i25);
  assume {:sourceloc "aws_byte_cursor_advance.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call $i27 := assert_.i32($i26);
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 17} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1, $mul.ref(0, 16)), $mul.ref(8, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 17} true;
  assume {:verifier.code 0} true;
  $p29 := $load.ref($M.1, $p28);
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 24} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(0, 1));
  $p31 := $add.ref($add.ref($p0, $mul.ref(0, 16)), $mul.ref(4, 1));
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $eq.ref($p29, $p31);
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 21} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i1.i32($i32);
  assume {:sourceloc "aws_byte_cursor_advance.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call $i34 := assert_.i32($i33);
  assume {:sourceloc "aws_byte_cursor_advance.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
