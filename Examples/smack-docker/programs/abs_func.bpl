...
// via /usr/local/bin/smack --no-verify -bpl abs_func.bpl abs_func.c
...
const abs_val: ref;
axiom (abs_val == $sub.ref(0, 1032));
procedure  abs_val($i0: i32)
  returns ($r: i32)
{
  var $i1: i1;
  var $i2: i32;
  var $i3: i32;
$bb0:
  assume {:sourceloc "abs_func.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "abs_val:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "abs_func.c", 4, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "abs_func.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "abs_func.c", 4, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "abs_func.c", 4, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "abs_func.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
$bb3:
  assume {:sourceloc "abs_func.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "abs_func.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "abs_func.c", 9, 11} true;
  ...
  assume {:sourceloc "abs_func.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "abs_func.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, $sub.i32(0, 1000));
  assume {:sourceloc "abs_func.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
...
$bb7:
  ...
  goto $bb4;
$bb8:
  assume {:sourceloc "abs_func.c", 11, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := abs_val($i0);
  call {:cexpr "r"} boogie_si_record_i32($i3);
  assume {:sourceloc "abs_func.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sge.i32($i3, 0);
  assume {:sourceloc "abs_func.c", 12, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "abs_func.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call $i6 := assert_.i32($i5);
  assume {:sourceloc "abs_func.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
