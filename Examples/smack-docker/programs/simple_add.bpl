...
// via /usr/local/bin/smack --no-verify -bpl simple_add.bpl simple_add.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "simple_add.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "simple_add.c", 6, 13} true;
  assume {:verifier.code 0} true;
  $i0 := $add.i32(1, 2);
  call {:cexpr "z"} boogie_si_record_i32($i0);
  assume {:sourceloc "simple_add.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 3);
  assume {:sourceloc "simple_add.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "simple_add.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call $i3 := assert_.i32($i2);
  assume {:sourceloc "simple_add.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
