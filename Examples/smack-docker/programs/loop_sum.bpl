...
// via /usr/local/bin/smack --no-verify -bpl loop_sum.bpl loop_sum.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "loop_sum.c", 5, 8} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "loop_sum.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "loop_sum.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "loop_sum.c", 5, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 5);
  assume {:sourceloc "loop_sum.c", 5, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "loop_sum.c", 6, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i0, $i1);
  call {:cexpr "sum"} boogie_si_record_i32($i3);
  assume {:sourceloc "loop_sum.c", 7, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "loop_sum.c", 8, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i0, 10);
  assume {:sourceloc "loop_sum.c", 8, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i1.i32($i5);
  assume {:sourceloc "loop_sum.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call $i7 := assert_.i32($i6);
  assume {:sourceloc "loop_sum.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "loop_sum.c", 5, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i1, 1);
...
axiom (__SMACK_decls == $sub.ref(0, 16512));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 17544));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 18576));
...
axiom (llvm.dbg.value == $sub.ref(0, 19608));
