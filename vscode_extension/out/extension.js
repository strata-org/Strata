            ...
            (0, child_process_1.exec)(command, { cwd: '/Users/mzwangg/Strata' }, (error, stdout, stderr) => {
                ...
                try {
                    ...
                    if (result.violations.length === 0) {
                        ...
                        vscode.window.showWarningMessage(`⚠️ Found ${result.violations.length} taint violation(s)`);
                    }
                }
                catch (parseError) {
            ...
            (0, child_process_1.exec)(command, { cwd: '/Users/mzwangg/Strata' }, (error, stdout, stderr) => {
                ...
                try {
                    ...
                    if (result.violations.length === 0) {
                        ...
                        vscode.window.showWarningMessage(`⚠️ Found ${result.violations.length} uninitialized field access violation(s)`);
                    }
                }
                catch (parseError) {
                    vscode.window.showErrorMessage(`Failed to parse analysis results: ${parseError}`);
            ...
            (0, child_process_1.exec)(command, { cwd: '/Users/mzwangg/Strata' }, (error, stdout, stderr) => {
                ...
                try {
                    ...
                    if (result.violations.length === 0) {
                        ...
                        vscode.window.showWarningMessage(`⚠️ Found ${result.violations.length} value validation violation(s)`);
                    }
                }
                catch (parseError) {
                    vscode.window.showErrorMessage(`Failed to parse analysis results: ${parseError}`);
