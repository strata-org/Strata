...
function runHeapHigherOrderTaintAnalysis() {
    ...
    vscode.window.withProgress({
        ...
        const results: Array<{editor: vscode.TextEditor, violations: Violation[]}> = [];
        ...
        vscode.window.showInformationMessage(
            `✅ Heap Higher Order Taint Analysis completed on ${supportedEditors.length} file(s)`
        );
    });
}
...
function runTaintAnalysis() {
    ...
    vscode.window.withProgress({
        ...
        vscode.window.showInformationMessage(
            `✅ Taint Analysis completed on ${supportedEditors.length} file(s)`
        );
    });
}
...
function runUninitializedFieldAccess() {
    ...
    vscode.window.withProgress({
        ...
        vscode.window.showInformationMessage(
            `✅ Uninitialized Field Access Analysis completed on ${supportedEditors.length} file(s)`
        );
    });
}
...
function runValueValidation() {
    ...
    vscode.window.withProgress({
        ...
        vscode.window.showInformationMessage(
            `✅ Value Validation Analysis completed on ${supportedEditors.length} file(s)`
        );
    });
}
