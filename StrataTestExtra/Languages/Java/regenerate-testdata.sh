...
(cd "$STRATA_ROOT" && lake exe strata javaGen "$STRATA_ROOT/StrataTestExtra/Languages/Java/$TESTDATA/Simple.dialect.st" com.strata.simple "$STRATA_ROOT/StrataTestExtra/Languages/Java/$GEN_DIR")
...
(cd "$STRATA_ROOT" && lake exe strata print --include "$STRATA_ROOT/StrataTestExtra/Languages/Java/$TESTDATA" "$STRATA_ROOT/StrataTestExtra/Languages/Java/$TESTDATA/comprehensive.ion" 2>&1 | tail -1)
