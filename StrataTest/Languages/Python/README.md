...
```
cd Tools/Python
python -m strata.gen py_to_strata --dialect dialects/Python.dialect.st.ion ../../StrataTest/Languages/Python/test.py ../../StrataTest/Languages/Python/test.python.st.ion
```
