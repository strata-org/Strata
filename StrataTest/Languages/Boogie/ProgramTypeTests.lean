...
#guard_msgs in
#eval do let ans ← typeCheckAndPartialEval Strata.SMT.Options.default bad_prog
         return (format ans)
...
-/
#guard_msgs in
#eval do let ans ← typeCheckAndPartialEval Strata.SMT.Options.default good_prog
         return (format ans)
...
-/
#guard_msgs in
#eval do let ans ← typeCheckAndPartialEval Strata.SMT.Options.default outOfScopeVarProg
         return (format ans)
