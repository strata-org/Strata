...
Property: assert
Assumptions:
<label_ite_cond_true: (~Int.Lt a b)>: if a < b then a < b else true
<label_ite_cond_false: !(~Int.Lt a b)>: if if a < b then false else true then if a < b then false else true else true
Obligation:
true
