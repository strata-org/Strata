...
special-name-for-old-measure-value: special-name-for-old-measure-value == $__n0 - $__i3
Obligation:
...
special-name-for-old-measure-value: if 0 < $__n0 then special-name-for-old-measure-value == $__n0 - $__i3 else true
