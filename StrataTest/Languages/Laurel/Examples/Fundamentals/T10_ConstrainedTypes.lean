...
// Function call inside forall — lifted out, postcondition assumed
procedure forallCallPosition() {
  var b: bool := forall(n: int) => opaqueNatFunc() >= 0;
  assert b
};
"
