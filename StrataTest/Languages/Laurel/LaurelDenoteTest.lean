...
/-!
# Tests for Laurel Denotational Interpreter
...
namespace Strata.Laurel.DenoteTest
...
#guard getOutcome (denoteStmt trivialEval emptyProc 10 emptyHeap (singleStore "x" (.vInt 7))
...
#guard
  let σ₀ := singleStore "x" (.vInt 0)
  let r := denoteArgs trivialEval emptyProc 10 emptyHeap σ₀
    [mk (.Assign [⟨.Identifier "x", emd⟩] (mk (.LiteralInt 1))),
...
#guard
  let r := denoteArgs trivialEval emptyProc 10 emptyHeap emptyStore
...
-- Empty block is void
#guard getOutcome (denoteBlock trivialEval emptyProc 10 emptyHeap emptyStore [])
  = some (.normal .vVoid)

/-! ## Fuel Exhaustion Test -/

-- Fuel 0 returns none
#guard denoteStmt trivialEval emptyProc 0 emptyHeap emptyStore (.LiteralInt 1) = none

/-! ## Stuck State Tests -/

-- Undefined variable returns none
#guard denoteStmt trivialEval emptyProc 10 emptyHeap emptyStore (.Identifier "undef") = none

-- Abstract returns none
#guard denoteStmt trivialEval emptyProc 10 emptyHeap emptyStore .Abstract = none

-- All returns none
#guard denoteStmt trivialEval emptyProc 10 emptyHeap emptyStore .All = none

-- Hole returns none
#guard denoteStmt trivialEval emptyProc 10 emptyHeap emptyStore .Hole = none
...
#guard
  ...
  let r := denoteStmt trivialEval emptyProc 100 emptyHeap σ₀ whileStmt
...
#guard
  let r := denoteStmt trivialEval emptyProc 10 emptyHeap emptyStore (.New "MyClass")
...
#guard
  ...
  getOutcome (denoteStmt trivialEval emptyProc 10 emptyHeap σ .This)
  = some (.normal (.vRef 42))
...
#guard
  ...
  let r := denoteStmt trivialEval π 10 emptyHeap emptyStore
    (.Block [
