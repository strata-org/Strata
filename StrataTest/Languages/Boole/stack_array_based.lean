...
Property: assert
Assumptions:
StackInit_requires_0_1015: cap@2 >= 0
Obligation:
true
...
Property: assert
Assumptions:
Push_requires_5_1443: top@5 < cap@2
Obligation:
true
...
Push_requires_5_1443: top@5 < cap@2
Obligation:
forall __q0 : int :: 1 <= __q0 && __q0 <= top@5 ==> (S@4[top@5 + 1:=x@6])[__q0] == S@4[__q0]

Label: Pop_ensures_10_1840
Property: assert
Assumptions:
Pop_requires_9_1803: top@7 > 0
Obligation:
true
