...
function lambda_0 (l_0 : bool, l_1 : int, l_2 : int) : Map int int;
axiom [a1]: forall a : (Map int bool) :: forall b : (Map int bool) ::  { diff(a, b) }
  diff(a, b) == diff(b, a);
axiom [a2]: forall l_0 : bool :: forall l_1 : int :: forall l_2 : int :: forall y : int ::  { (lambda_0(l_0, l_1, l_2))[y] }
  (lambda_0(l_0, l_1, l_2))[y] == (lambda_0(l_0, l_2, l_1))[y];
-/
#guard_msgs in
