...
Property: division by zero check
Assumptions:
<label_ite_cond_true: (~Int.Gt a #0)>: a@0 > 0
Obligation:
!(a@0 == 0)
...
Property: division by zero check
Assumptions:
<label_ite_cond_true: (~Int.Lt (~Int.SafeDiv i n) #10)>: 0 / n@0 < 10
assume_guard_0: i@1 / n@0 < 10
