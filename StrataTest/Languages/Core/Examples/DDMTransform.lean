...
procedure Foo1(x1: int, g: int) returns (r1: int, g': int)
  spec {
    // Template: <f>.token(inputs, old globals, globals, returns);
    free ensures Foo1_token(x1,g,g',r1);
  };

procedure Foo2(x2: int, g: int) returns (r2: int, g': int)
  spec {
    free ensures Foo2_token(x2,g,g',r2);
  };

procedure MS_check (x1: int, x2: int, g: int) returns (r1: int, r2: int, g': int)
  spec {
