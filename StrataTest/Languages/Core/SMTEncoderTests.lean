...
-/
#guard_msgs in
#eval verify simpleMapProgram (options := {Core.VerifyVerifyOptions.quiet with useArrayTheory := false})
...
-/
#guard_msgs in
#eval verify simpleMapProgram (options := {Core.VerifyVerifyOptions.quiet with useArrayTheory := true})
