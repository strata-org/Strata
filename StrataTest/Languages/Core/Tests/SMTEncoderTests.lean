...
/--
info: "(forall ((n Int)) (exists ((m Int)) (= n m)))\n"
-/
#guard_msgs in
...
/--
info: "; f\n(declare-fun f (Int) Int)\n; x\n(declare-const x Int)\n(exists ((i Int)) (! (= (f i) x) :pattern ((f i))))\n"
-/
#guard_msgs in
#eval toSMTTermString
   (.quant () .exist "i" (.some .int) (.app () (.fvar () "f" (.some (.arrow .int .int))) (.bvar () 0))
...
/--
info: "; f\n(declare-fun f (Int Int) Int)\n; x\n(declare-const x Int)\n(forall ((m Int) (n Int)) (! (= (f n m) x) :pattern ((f n m))))\n"
-/
#guard_msgs in
#eval toSMTTermString
...
/-- info: "(forall (($__bv0 Int)) (exists (($__bv1 Int)) (= $__bv0 $__bv1)))\n" -/
#guard_msgs in
#eval toSMTTermString
...
/--
info: "(forall ((x Int)) (exists ((x@1 Int)) (= x x@1)))\n"
-/
#guard_msgs in
#eval toSMTTermString
...
/--
info: "(forall ((x Int) (x@1 Int) (x@2 Int)) (= x@2 x))\n"
-/
#guard_msgs in
#eval toSMTTermString
  (.quant () .all "x" (.some .int) (LExpr.noTrigger ())
