...
def test1_constructorApplication : IO String := do
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "x") (.forAll [] (LMonoTy.tcons "Option" [.int]))
      (some (LExpr.op () (CoreIdent.unres "None") (.some (LMonoTy.tcons "Option" [.int])))) .empty,
    ...
    Statement.init (CoreIdent.unres "y") (.forAll [] (LMonoTy.tcons "Option" [.int]))
      (some (LExpr.app ()
        ...
        (LExpr.intConst () 42))) .empty,

    -- Trivial assertion to verify the program
    Statement.assert "trivial" (LExpr.boolConst () true) .empty
  ]
  ...
  let statements : List Statement := [
    ...
    Statement.assert "x_is_none"
      (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "x") (.some (LMonoTy.tcons "Option" [.int])))) .empty,
    ...
    Statement.assert "y_is_some"
      (LExpr.app ()
        (LExpr.op () (CoreIdent.unres "isSome")
          (.some (LMonoTy.arrow (LMonoTy.tcons "Option" [.int]) .bool)))
        (LExpr.fvar () (CoreIdent.unres "y") (.some (LMonoTy.tcons "Option" [.int])))) .empty
  ]
  ...
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "value") (.forAll [] LMonoTy.int)
      (some (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "opt") (.some (LMonoTy.tcons "Option" [.int]))))) .empty,
    ...
    Statement.init (CoreIdent.unres "list") (.forAll [] (LMonoTy.tcons "List" [.int]))
      (some (LExpr.app ()
        (LExpr.app ()
          ...
          (LExpr.intConst () 1))
        (LExpr.op () (CoreIdent.unres "Nil") (.some (LMonoTy.tcons "List" [.int]))))) .empty,
    ...
    Statement.init (CoreIdent.unres "head") (.forAll [] LMonoTy.int)
      (some (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "list") (.some (LMonoTy.tcons "List" [.int]))))) .empty,

    -- Assert head == 1
    Statement.assert "head_is_1"
      (LExpr.eq ()
        (LExpr.fvar () (CoreIdent.unres "head") (.some .int))
        (LExpr.intConst () 1)) .empty
  ]
    ...
    Statement.init (CoreIdent.unres "listOfOpt")
      ...
      (some (LExpr.app ()
        ...
        (LExpr.op () (CoreIdent.unres "Nil")
          (.some (LMonoTy.tcons "List" [LMonoTy.tcons "Option" [.int]]))))) .empty,
    ...
    Statement.init (CoreIdent.unres "value") (.forAll [] LMonoTy.int)
      (some (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "headOpt")
          (.some (LMonoTy.tcons "Option" [.int]))))) .empty,
...
def test5_testerWithHavoc : IO String := do
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "x") (.forAll [] (LMonoTy.tcons "Option" [.int]))
      (some (LExpr.op () (CoreIdent.unres "None") (.some (LMonoTy.tcons "Option" [.int])))) .empty,
    Statement.havoc (CoreIdent.unres "x") .empty,
  ...
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "opt") (.forAll [] (LMonoTy.tcons "Option" [.int]))
      (some (LExpr.app ()
        (LExpr.op () (CoreIdent.unres "Some")
          (.some (LMonoTy.arrow .int (LMonoTy.tcons "Option" [.int]))))
        (LExpr.intConst () 0))) .empty,
    Statement.havoc (CoreIdent.unres "opt") .empty,
...
def test7_listWithHavoc : IO String := do
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "xs") (.forAll [] (LMonoTy.tcons "List" [.int]))
      (some (LExpr.op () (CoreIdent.unres "Nil") (.some (LMonoTy.tcons "List" [.int])))) .empty,
    Statement.havoc (CoreIdent.unres "xs") .empty,
    ...
    Statement.assume "xs_is_cons"
      (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "xs") (.some (LMonoTy.tcons "List" [.int])))) .empty,
...
def test8_hiddenTypeRecursion : IO String := do
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "container")
      ...
      (some (LExpr.op () (CoreIdent.unres "Empty") (.some (LMonoTy.tcons "Container" [.int])))) .empty,

    -- Havoc the container to make it non-deterministic
    Statement.havoc (CoreIdent.unres "container") .empty,
    ...
    Statement.assume "container_not_empty"
      (LExpr.app ()
        ...
        (LExpr.app ()
          ...
          (LExpr.fvar () (CoreIdent.unres "container") (.some (LMonoTy.tcons "Container" [.int]))))) .empty,
  ...
  let statements : List Statement := [
    ...
    Statement.init (CoreIdent.unres "tree") (.forAll [] (LMonoTy.tcons "RoseTree" [.int]))
      (some (LExpr.app ()
        (LExpr.app ()
          ...
          (LExpr.intConst () 1))
        (LExpr.op () (CoreIdent.unres "FNil") (.some (LMonoTy.tcons "Forest" [.int]))))) .empty,

    -- Havoc the tree
    Statement.havoc (CoreIdent.unres "tree") .empty,
    ...
    Statement.init (CoreIdent.unres "val") (.forAll [] LMonoTy.int)
      (some (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "tree") (.some (LMonoTy.tcons "RoseTree" [.int]))))) .empty,
    ...
    Statement.init (CoreIdent.unres "forest") (.forAll [] (LMonoTy.tcons "Forest" [.int]))
      (some (LExpr.op () (CoreIdent.unres "FNil") (.some (LMonoTy.tcons "Forest" [.int])))) .empty,

    -- Havoc the forest
    Statement.havoc (CoreIdent.unres "forest") .empty,
    ...
    Statement.assume "forest_is_fcons"
      (LExpr.app ()
        ...
        (LExpr.fvar () (CoreIdent.unres "forest") (.some (LMonoTy.tcons "Forest" [.int])))) .empty,
