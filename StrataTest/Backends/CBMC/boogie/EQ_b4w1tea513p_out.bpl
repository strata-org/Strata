...
const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.Object: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.java.io.Serializable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.Throwable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.Exception: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.RuntimeException: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.com.rpc.exception.SerializeException: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.Comparable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.CharSequence: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.constant.Constable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.constant.ConstantDesc: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique otherfile.String: javaType;
...
axiom otherfile.$extends(otherfile.java.io.Serializable, otherfile.Object);

axiom otherfile.$extends(otherfile.Throwable, otherfile.Object);

axiom otherfile.$extends(otherfile.Throwable, otherfile.java.io.Serializable);

axiom otherfile.$extends(otherfile.Exception, otherfile.Throwable);

axiom otherfile.$extends(otherfile.RuntimeException, otherfile.Exception);

axiom otherfile.$extends(otherfile.com.rpc.exception.SerializeException, otherfile.RuntimeException);

axiom otherfile.$extends(otherfile.Comparable, otherfile.Object);

axiom otherfile.$extends(otherfile.CharSequence, otherfile.Object);

axiom otherfile.$extends(otherfile.constant.Constable, otherfile.Object);

axiom otherfile.$extends(otherfile.constant.ConstantDesc, otherfile.Object);

axiom otherfile.$extends(otherfile.String, otherfile.Object);

axiom otherfile.$extends(otherfile.String, otherfile.constant.ConstantDesc);

axiom otherfile.$extends(otherfile.String, otherfile.Comparable);

axiom otherfile.$extends(otherfile.String, otherfile.CharSequence);

axiom otherfile.$extends(otherfile.String, otherfile.java.io.Serializable);

axiom otherfile.$extends(otherfile.String, otherfile.constant.Constable);
...
procedure {:prefix "otherfile"} otherfile.com.rpc.exception.SerializeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref);
...
procedure {:prefix "otherfile"} otherfile.RuntimeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref);
  modifies otherfile.$refArrHeap, otherfile.$arrSizeHeap, otherfile.$stringValueHeap, otherfile.$stringSizeHeap, otherfile.$boolArrHeap, otherfile.$charArrHeap, otherfile.$floatArrHeap, otherfile.$shortArrHeap, otherfile.$longArrHeap, otherfile.$heap, otherfile.$doubleArrHeap, otherfile.$intArrHeap, otherfile.$byteArrHeap;
...
implementation otherfile.com.rpc.exception.SerializeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref)
{
  var this$$lp$Lcom.rpc.exception.SerializeException$$rp$: ref;
  var message$$lp$LString$$rp$: ref;

  anon0:
    $exception := otherfile.$null;
    assume {:sourceloc "SerializeException.java", -1, -1, -1, -1} $this != otherfile.$null;
    assume $in_parameter__0 == otherfile.$null || otherfile.$heap[$in_parameter__0][otherfile.$alloc];
    assume otherfile.$extends(otherfile.$heap[$in_parameter__0][otherfile.$type], otherfile.String);
    assert {:sourceloc "SerializeException.java", -1, -1, -1, -1} true;
    this$$lp$Lcom.rpc.exception.SerializeException$$rp$ := $this;
    assert {:sourceloc "SerializeException.java", -1, -1, -1, -1} true;
    message$$lp$LString$$rp$ := $in_parameter__0;
    assert {:sourceloc "SerializeException.java", 10, -1, -1, -1} true;
    call $exception := otherfile.RuntimeException$$la$init$ra$$$lp$LString$$rp$$V(this$$lp$Lcom.rpc.exception.SerializeException$$rp$, message$$lp$LString$$rp$);
  ...
  anon2:
    assert {:sourceloc "SerializeException.java", 11, -1, -1, -1} true;
    goto block1;
...
const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.Object: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.java.io.Serializable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.Throwable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.Exception: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.RuntimeException: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.com.rpc.exception.SerializeException: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.Comparable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.CharSequence: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.constant.Constable: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.constant.ConstantDesc: javaType;

const {:sourceloc "SerializeException.java", -1, -1, -1, -1} unique reffile.String: javaType;
...
procedure {:prefix "reffile"} reffile.com.rpc.exception.SerializeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref);
  modifies otherfile.$refArrHeap, otherfile.$arrSizeHeap, otherfile.$stringValueHeap, otherfile.$stringSizeHeap, otherfile.$boolArrHeap, otherfile.$charArrHeap, otherfile.$floatArrHeap, otherfile.$shortArrHeap, otherfile.$longArrHeap, otherfile.$heap, otherfile.$doubleArrHeap, otherfile.$intArrHeap, otherfile.$byteArrHeap;



procedure {:prefix "reffile"} reffile.RuntimeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref);
  modifies otherfile.$refArrHeap, otherfile.$arrSizeHeap, otherfile.$stringValueHeap, otherfile.$stringSizeHeap, otherfile.$boolArrHeap, otherfile.$charArrHeap, otherfile.$floatArrHeap, otherfile.$shortArrHeap, otherfile.$longArrHeap, otherfile.$heap, otherfile.$doubleArrHeap, otherfile.$intArrHeap, otherfile.$byteArrHeap;
...
implementation reffile.com.rpc.exception.SerializeException$$la$init$ra$$$lp$LString$$rp$$V($this: ref, $in_parameter__0: ref) returns ($exception: ref)
{
  var this$$lp$Lcom.rpc.exception.SerializeException$$rp$: ref;
  var msg$$lp$LString$$rp$: ref;
  ...
  anon0:
    ...
    this$$lp$Lcom.rpc.exception.SerializeException$$rp$ := $this;
    assert {:sourceloc "SerializeException.java", -1, -1, -1, -1} true;
    msg$$lp$LString$$rp$ := $in_parameter__0;
    assert {:sourceloc "SerializeException.java", 10, -1, -1, -1} true;
    call $exception := reffile.RuntimeException$$la$init$ra$$$lp$LString$$rp$$V(this$$lp$Lcom.rpc.exception.SerializeException$$rp$, msg$$lp$LString$$rp$);
    goto anon3_Then, anon3_Else;
