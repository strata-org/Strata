...
const {:sourceloc "SameV.java", -1, -1, -1, -1} unique otherfile.benchmarks.airy.MAX.Eq.SameV: javaType;
...
axiom otherfile.$extends(otherfile.benchmarks.airy.MAX.Eq.SameV, otherfile.Object);
...
procedure {:prefix "otherfile"} otherfile.benchmarks.airy.MAX.Eq.SameV$$la$init$ra$$$lp$$rp$$V($this: ref) returns ($exception: ref);
...
procedure {:prefix "otherfile"} otherfile.benchmarks.airy.MAX.Eq.SameV$snippet$$lp$D$D$rp$$D($in_parameter__0: java_double, $in_parameter__1: java_double) returns ($return: java_double, $exception: ref);
...
implementation otherfile.benchmarks.airy.MAX.Eq.SameV$$la$init$ra$$$lp$$rp$$V($this: ref) returns ($exception: ref)
{
  var l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$: ref;

  anon0:
    $exception := otherfile.$null;
    assume {:sourceloc "SameV.java", -1, -1, -1, -1} $this != otherfile.$null;
    assert {:sourceloc "SameV.java", -1, -1, -1, -1} true;
    l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$ := $this;
    assert {:sourceloc "SameV.java", 2, -1, -1, -1} true;
    call $exception := otherfile.Object$$la$init$ra$$$lp$$rp$$V(l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$);
...
implementation otherfile.benchmarks.airy.MAX.Eq.SameV$snippet$$lp$D$D$rp$$D($in_parameter__0: java_double, $in_parameter__1: java_double) returns ($return: java_double, $exception: ref)
{
  var $stack4$$lp$B$rp$: java_byte;
  var $i0$$lp$I$rp$: java_int;
  var l0$$lp$D$rp$: java_double;
  var l2$$lp$D$rp$: java_double;

  anon0:
    $return := 0e0;
    $exception := otherfile.$null;
    assert {:sourceloc "SameV.java", -1, -1, -1, -1} true;
    l0$$lp$D$rp$ := $in_parameter__0;
    assert {:sourceloc "SameV.java", -1, -1, -1, -1} true;
    l2$$lp$D$rp$ := $in_parameter__1;
    assert {:sourceloc "SameV.java", 4, -1, -1, -1} true;
    $stack4$$lp$B$rp$ := otherfile.$intToByte(otherfile.$cmpDouble(l2$$lp$D$rp$, l0$$lp$D$rp$));
    assert {:sourceloc "SameV.java", -1, -1, -1, -1} true;
    $i0$$lp$I$rp$ := otherfile.$byteToInt($stack4$$lp$B$rp$);
    assert {:sourceloc "SameV.java", 4, -1, -1, -1} true;
    goto anon4_Then, anon4_Else;

  anon4_Then:
    assume {:partition} otherfile.$geInt($i0$$lp$I$rp$, 0bv32);
    assert {:sourceloc "SameV.java", 4, -1, -1, -1} {:comment "thenblock"} true;
    goto block2;

  anon4_Else:
    assume {:partition} !otherfile.$geInt($i0$$lp$I$rp$, 0bv32);
    assert {:sourceloc "SameV.java", 4, -1, -1, -1} {:comment "elseblock"} true;
    goto anon3;
...
const {:sourceloc "SameV.java", -1, -1, -1, -1} unique reffile.benchmarks.airy.MAX.Eq.SameV: javaType;
...
procedure {:prefix "reffile"} reffile.benchmarks.airy.MAX.Eq.SameV$$la$init$ra$$$lp$$rp$$V($this: ref) returns ($exception: ref);
  modifies otherfile.$refArrHeap, otherfile.$arrSizeHeap, otherfile.$stringValueHeap, otherfile.$stringSizeHeap, otherfile.$boolArrHeap, otherfile.$charArrHeap, otherfile.$floatArrHeap, otherfile.$shortArrHeap, otherfile.$longArrHeap, otherfile.$heap, otherfile.$doubleArrHeap, otherfile.$intArrHeap, otherfile.$byteArrHeap;
...
procedure {:prefix "reffile"} reffile.benchmarks.airy.MAX.Eq.SameV$snippet$$lp$D$D$rp$$D($in_parameter__0: java_double, $in_parameter__1: java_double) returns ($return: java_double, $exception: ref);
...
implementation reffile.benchmarks.airy.MAX.Eq.SameV$$la$init$ra$$$lp$$rp$$V($this: ref) returns ($exception: ref)
{
  var l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$: ref;
  ...
  anon0:
    ...
    l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$ := $this;
    assert {:sourceloc "SameV.java", 2, -1, -1, -1} true;
    call $exception := reffile.Object$$la$init$ra$$$lp$$rp$$V(l0$$lp$Lbenchmarks.airy.MAX.Eq.SameV$$rp$);
    goto anon3_Then, anon3_Else;
...
implementation reffile.benchmarks.airy.MAX.Eq.SameV$snippet$$lp$D$D$rp$$D($in_parameter__0: java_double, $in_parameter__1: java_double) returns ($return: java_double, $exception: ref)
{
  var $stack4$$lp$B$rp$: java_byte;
  var $i0$$lp$I$rp$: java_int;
  var l2$$lp$D$rp$: java_double;
  ...
  anon4_Then:
    assume {:partition} otherfile.$leInt($i0$$lp$I$rp$, 0bv32);
    assert {:sourceloc "SameV.java", 4, -1, -1, -1} {:comment "thenblock"} true;
    goto block2;
