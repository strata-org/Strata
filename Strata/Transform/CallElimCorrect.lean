  ...
  case app m c fn fih eih =>
    ...
    . -- is an old var
      ...
      . -- is an old var that is not substituted, use congruence
        ...
        let eHelper: Expression.Expr := Lambda.LExpr.op m (Visibility.unres, "old") ty0
  ...
  case app fn e m Hnfn Hne Hwf ih1 ih2 =>
    ...
    . -- is a normal expression (non-old)
      ...
      · rename_i x1 x2 x3 m1 id ty2 x7
        have hI: Lambda.LExpr.op x2 (Visibility.unres, "old") x3 = Lambda.LExpr.op x2 (Visibility.unres, "old") x3 := by rfl
