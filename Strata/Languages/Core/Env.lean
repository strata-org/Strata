...
-- nosourcerange-file: synthesized fallback expressions (default values, scope formatting) use
-- SourceRange.none because they are generated by the evaluator, not parsed from source.
