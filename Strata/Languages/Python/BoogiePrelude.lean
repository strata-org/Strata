...
axiom [Error_isTypeError_TypeError]:
    (forall msg : string :: {Error_isTypeError(Error_TypeError(msg))}
        Error_isTypeError(Error_TypeError(msg)));
axiom [Error_isAttributeError_AttributeError]:
    (forall msg : string :: {Error_isAttributeError(Error_AttributeError(msg))}
...
axiom (forall s1:StrOrNone, s2: StrOrNone :: s1 != s2 ==>
        strOrNone_toObject(s1) != strOrNone_toObject(s2));
axiom (forall s : StrOrNone ::
...
axiom (forall v : BoolOrStrOrNone ::
