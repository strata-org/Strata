...
datatype Error () {
  Error_TypeError(type_error_msg: string),
  Error_AttributeError(attr_error_msg: string),
  Error_RePatternError(re_pattern_error_msg: string),
  Error_Unimplemented(unimplemented_msg: string)
};
...
datatype ExceptErrorRegex () {
  ExceptErrorRegex_mkOK(ok_val: regex),
  ExceptErrorRegex_mkErr(err_val: Error)
};
...
datatype ExceptOrNone () {
  ...
  ExceptOrNone_mk_none(except_none_val: None)
};

datatype IntOrNone () {
  IntOrNone_mk_int(int_val: int),
  IntOrNone_mk_none(int_none_val: None)
};

datatype StrOrNone () {
  StrOrNone_mk_str(str_val: string),
  StrOrNone_mk_none(str_none_val: None)
};
...
axiom (forall s : StrOrNone :: {StrOrNone..isStrOrNone_mk_str(s)}
        ...
        Object_len(strOrNone_toObject(s)) == str.len(str_val(s)));

datatype AnyOrNone () {
  AnyOrNone_mk_str(any_str_val: string),
  AnyOrNone_mk_none(any_none_val: None)
};

datatype BoolOrNone () {
  BoolOrNone_mk_str(bool_str_val: string),
  BoolOrNone_mk_none(bool_none_val: None)
};

datatype BoolOrStrOrNone () {
  BoolOrStrOrNone_mk_bool(bsn_bool_val: bool),
  BoolOrStrOrNone_mk_str(bsn_str_val: string),
  BoolOrStrOrNone_mk_none(bsn_none_val: None)
};

datatype DictStrStrOrNone () {
  DictStrStrOrNone_mk_str(dssn_str_val: string),
  DictStrStrOrNone_mk_none(dssn_none_val: None)
};

datatype BytesOrStrOrNone () {
  BytesOrStrOrNone_mk_none(bosn_none_val: None),
  BytesOrStrOrNone_mk_str(bosn_str_val: string)
};
...
spec {
  ...
  requires [req_opt_name_none_or_bar]: (if (StrOrNone..isStrOrNone_mk_str(opt_name)) then (str_val(opt_name) == "bar") else true);
...
}
{
  ...
  assert [assert_opt_name_none_or_bar]: (if (StrOrNone..isStrOrNone_mk_str(opt_name)) then (str_val(opt_name) == "bar") else true);
