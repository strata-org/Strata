...
partial def collectVarDecls (translation_ctx : TranslationContext) (stmts: Array (Python.stmt SourceRange)) : List Core.Statement :=
  ...
  let toCore (p: String × String) : List Core.Statement :=
    ...
    let ty_name := p.snd
    match ty_name with
    | "bool" => [(.init name t[bool] (some (.boolConst Strata.SourceRange.none false))), (.havoc name)]
    | "str" => [(.init name t[string] (some (.strConst Strata.SourceRange.none ""))), (.havoc name)]
    | "int" => [(.init name t[int] (some (.intConst Strata.SourceRange.none 0))), (.havoc name)]
    | "float" => [(.init name t[string] (some (.strConst Strata.SourceRange.none "0.0"))), (.havoc name)] -- Floats as strs for now
    | "bytes" => [(.init name t[string] (some (.strConst Strata.SourceRange.none ""))), (.havoc name)]
...
partial def handleDict (keys: Array (Python.opt_expr SourceRange)) (values: Array (Python.expr SourceRange)) : PyExprTranslated :=
  ...
  let res := zipped.toList.flatMap (λ (k, v) =>
    ...
    let in_dict := (.assume s!"assume_{n}_in_dict" (.app Strata.SourceRange.none (.app Strata.SourceRange.none (.op Strata.SourceRange.none "str_in_dict_str_any" none) (.strConst Strata.SourceRange.none n)) dict))
    match v with
    | .Call _ f args _ =>
      match f with
      | .Name _ {ann := _ , val := "str"} _ =>
        ...
        let dict_of_v_is_k := (.assume s!"assume_{n}_key" (.eq Strata.SourceRange.none (.app Strata.SourceRange.none (.app Strata.SourceRange.none (.op Strata.SourceRange.none "dict_str_any_get_str" none) dict) (.strConst Strata.SourceRange.none n)) dt))
        [in_dict, dict_of_v_is_k]
      | _ => panic! "Unsupported function when constructing map"
    | _ =>
      let dict_of_v_is_k := (.assume s!"assume_{n}_key" (.eq Strata.SourceRange.none (.app Strata.SourceRange.none (.app Strata.SourceRange.none (.op Strata.SourceRange.none "dict_str_any_get_str" none) dict) (.strConst Strata.SourceRange.none n)) (.strConst Strata.SourceRange.none "DummyVal")))
      [in_dict, dict_of_v_is_k])
...
partial def initTmpParam (p: Python.expr SourceRange × String) : List Core.Statement :=
  ...
  | .Call _ f args _ =>
    ...
    | .Name _ n _ =>
      match n.val with
      | "json_dumps" => [(.init p.snd t[string] (some (.strConst Strata.SourceRange.none ""))), .call [p.snd, "maybe_except"] "json_dumps" [(.app Strata.SourceRange.none (.op Strata.SourceRange.none "DictStrAny_mk" none) (.strConst Strata.SourceRange.none "DefaultDict")), (Strata.Python.TypeStrToCoreExpr "IntOrNone")]]
      | "str" =>
        assert! args.val.size == 1
        [(.init p.snd t[string] (some (.strConst Strata.SourceRange.none ""))), .set p.snd (.app Strata.SourceRange.none (.op Strata.SourceRange.none "datetime_to_str" none) ((PyExprToCore default args.val[0]!).expr))]
      | "int" => [(.init p.snd t[int] (some (.intConst Strata.SourceRange.none 0))), .set p.snd (.op Strata.SourceRange.none "datetime_to_int" none)]
...
partial def exceptHandlersToCore (jmp_targets: List String) (translation_ctx: TranslationContext) (h : Python.excepthandler SourceRange) : List Core.Statement :=
  ...
  | .ExceptHandler _ ex_ty _ body =>
    ...
    | .some ex_ty =>
      ...
      res.stmts ++ [call]
    | .none =>
      [.set "exception_ty_matches" (.boolConst Strata.SourceRange.none false)]
...
partial def handleComprehension (lhs: Python.expr SourceRange) (gen: Array (Python.comprehension SourceRange)) : List Core.Statement :=
  ...
  | .mk_comprehension _ _ itr _ _ =>
    ...
    let else_ss: List Core.Statement := [.set (PyExprToString lhs) (.op Strata.SourceRange.none "ListStr_nil" none)]
...
def pythonFuncToCore (name : String) (args: List (String × String)) (body: Array (Python.stmt SourceRange)) (ret : Option (Python.expr SourceRange)) (spec : Core.Procedure.Spec) (translation_ctx : TranslationContext) : Core.Procedure :=
  ...
  let varDecls := collectVarDecls translation_ctx body ++ [(.init "exception_ty_matches" t[bool] (some (.boolConst Strata.SourceRange.none false))), (.havoc "exception_ty_matches")]
