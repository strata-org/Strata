...
partial def collectVarDecls (translation_ctx : TranslationContext) (stmts: Array (Python.stmt SourceRange)) : List Core.Statement :=
  ...
  let toCore (p: String × String) : List Core.Statement :=
    ...
    let ty_name := p.snd
    match ty_name with
    | "bool" => [(.init name t[bool] (.det (.boolConst Strata.SourceRange.none false)) .empty), (.havoc name .empty)]
    | "str" => [(.init name t[string] (.det (.strConst Strata.SourceRange.none "")) .empty), (.havoc name .empty)]
    | "int" => [(.init name t[int] (.det (.intConst Strata.SourceRange.none 0)) .empty), (.havoc name .empty)]
    | "float" => [(.init name t[string] (.det (.strConst Strata.SourceRange.none "0.0")) .empty), (.havoc name .empty)] -- Floats as strs for now
    | "bytes" => [(.init name t[string] (.det (.strConst Strata.SourceRange.none "")) .empty), (.havoc name .empty)]
...
partial def initTmpParam (translation_ctx: TranslationContext) (p: Python.expr SourceRange × String) : List Core.Statement :=
  ...
  | .Call _ f args _ =>
    ...
    | .Name _ n _ =>
      ...
      | "int" => [(.init p.snd t[int] (.det (.intConst Strata.SourceRange.none 0)) md), .set p.snd (.op Strata.SourceRange.none "datetime_to_int" none) md]
...
def pythonFuncToCore (name : String) (args: List (String × String)) (body: Array (Python.stmt SourceRange)) (ret : Option (Python.expr SourceRange)) (spec : Core.Procedure.Spec) (translation_ctx : TranslationContext) : Core.Procedure :=
  ...
  let varDecls := collectVarDecls translation_ctx body ++ [(.init "exception_ty_matches" t[bool] (.det (.boolConst Strata.SourceRange.none false)) .empty), (.havoc "exception_ty_matches" .empty)]
