...
-/
#guard_msgs in
#eval verify "z3" Inhabited.default irrelevantAxiomsTestPgm {Options.quiet with removeIrrelevantAxioms := true}
...
-/
#guard_msgs in
#eval verify "z3" Inhabited.default irrelevantAxiomsTestPgm {Options.quiet with removeIrrelevantAxioms := false}
