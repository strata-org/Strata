    ...
    | _ => do
      ...
      let (ctx, isNew) ←
        ...
        | some body =>
          ...
          -- `.bvar`s.
          let bvars := (List.range formals.length).map (fun i => LExpr.bvar MetaData.empty i)
...
#eval toSMTTermString
  (.quant .empty .all (.some .int) (LExpr.noTrigger .empty)
   (.quant .empty .exist (.some .int) (LExpr.noTrigger .empty)
   (.eq .empty (.bvar .empty 1) (.bvar .empty 0))))
...
#eval toSMTTermString
   (.quant .empty .exist (.some .int) (LExpr.noTrigger .empty)
   (.eq .empty (.bvar .empty 0) (.fvar .empty "x" (.some .int))))
...
#guard_msgs in
#eval toSMTTermString
   (.quant .empty  .exist (.some .int) (.app .empty (.fvar .empty "f" (.some (.arrow .int .int))) (.bvar .empty 0))
   (.eq .empty (.bvar .empty 0) (.fvar .empty "x" (.some .int))))
...
#eval toSMTTermString
   (.quant .empty .exist (.some .int) (.app .empty (.fvar .empty "f" (.some (.arrow .int .int))) (.bvar .empty 0))
   (.eq .empty (.app .empty (.fvar .empty "f" (.some (.arrow .int .int))) (.bvar .empty 0)) (.fvar .empty "x" (.some .int))))

/-- info: "Cannot encode expression (f %0)" -/
#guard_msgs in
#eval toSMTTermString
   (.quant .empty .exist (.some .int) (.app .empty (.fvar .empty "f" (.none)) (.bvar .empty 0))
   (.eq .empty (.app .empty (.fvar .empty "f" (.some (.arrow .int .int))) (.bvar .empty 0)) (.fvar .empty "x" (.some .int))))
...
#guard_msgs in
#eval toSMTTermString
   (.quant .empty .exist (.some .int)
   (mkTriggerExpr [[.fvar .empty "f" (.some (.arrow .int .int))]])
   (.eq .empty (.app .empty (.fvar .empty "f" (.some (.arrow .int .int))) (.bvar .empty 0)) (.fvar .empty "x" (.some .int))))
...
#guard_msgs in
#eval toSMTTermString
   (.quant .empty .all (.some .int) (.bvar .empty 0) (.quant .empty .all (.some .int) (.app .empty (.app .empty (.op .empty "f" (.some (.arrow .int (.arrow .int .int)))) (.bvar .empty 0)) (.bvar .empty 1))
   (.eq .empty (.app .empty (.app .empty (.op .empty "f" (.some (.arrow .int (.arrow .int .int)))) (.bvar .empty 0)) (.bvar .empty 1)) (.fvar .empty "x" (.some .int)))))
...
#eval toSMTTermString
   (.quant .empty .all (.some .int) (.bvar .empty 0) (.quant .empty .all (.some .int) (.bvar .empty 0)
   (.eq .empty (.app .empty (.app .empty (.op .empty "f" (.some (.arrow .int (.arrow .int .int)))) (.bvar .empty 0)) (.bvar .empty 1)) (.fvar .empty "x" (.some .int)))))
   (ctx := SMT.Context.mk #[] #[UF.mk "f" ((TermVar.mk "m" TermType.int) ::(TermVar.mk "n" TermType.int) :: []) TermType.int] #[] #[] [])
   (E := {Env.init with exprEnv := {
    Env.init.exprEnv with
