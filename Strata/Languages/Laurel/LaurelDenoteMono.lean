...
theorem denoteStmt_fuel_mono
  ...
  | n + 1, m + 1 =>
    ...
    | Assign targets value =>
      ...
      | [] => simp [denoteStmt] at heval
      | [⟨.LiteralInt _, _⟩] => simp [denoteStmt] at heval
      | [⟨.LiteralBool _, _⟩] => simp [denoteStmt] at heval
      | [⟨.LiteralString _, _⟩] => simp [denoteStmt] at heval
      | [⟨.PrimitiveOp _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.IfThenElse _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Block _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Exit _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Return _, _⟩] => simp [denoteStmt] at heval
      | [⟨.While _ _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Assign _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.LocalVariable _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Assert _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Assume _, _⟩] => simp [denoteStmt] at heval
      | [⟨.StaticCall _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.New _, _⟩] => simp [denoteStmt] at heval
      | [⟨.PureFieldUpdate _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.ReferenceEquals _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.InstanceCall _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.This, _⟩] => simp [denoteStmt] at heval
      | [⟨.IsType _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.AsType _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Forall _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Exists _ _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Old _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Fresh _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Assigned _, _⟩] => simp [denoteStmt] at heval
      | [⟨.ProveBy _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.ContractOf _ _, _⟩] => simp [denoteStmt] at heval
      | [⟨.Abstract, _⟩] => simp [denoteStmt] at heval
      | [⟨.All, _⟩] => simp [denoteStmt] at heval
      | [⟨.Hole, _⟩] => simp [denoteStmt] at heval
      | _ :: _ :: _ => simp [denoteStmt] at heval
    ...
    | Abstract => simp [denoteStmt] at heval
    | All => simp [denoteStmt] at heval
    | Hole => simp [denoteStmt] at heval
