...
i := #0
transformed loop block : {first_iter_asserts : {assert [entry_invariant] ((~Int.Le i) n)
...
Assumptions:
(pre, ((~Int.Ge $__n0) #0))
(assume_guard, ((~Int.Lt $__i2) $__n0)) (assume_invariant, ((~Int.Le $__i2) $__n0)) (assume_measure_pos, ((~Int.Ge ((~Int.Sub $__n0) $__i2)) #0)) (not_guard, (~Bool.Not ((~Int.Lt $__i3) $__n0))) (invariant, ((~Int.Le $__i3) $__n0))
Proof Obligation:
($__i3 == $__n0)
