...
/--
Create a new TypingContext with a different GlobalContext but the same local bindings.
Used for recursive datatype definitions where the datatype name needs to be added
to the GlobalContext before parsing constructor field types.
-/
