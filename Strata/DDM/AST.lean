...
theorem Array.mem_pop_ne {α} (e : α) {as : Array α} (p : as.size > 0) :
  e ∈ as ↔ (e = as.back ∨ e ∈ as.pop) := by
  simp [Array.mem_iff_getElem]
  grind

theorem Array.of_mem_pop {α} {e : α} {as : Array α} :
  e ∈ as.pop → e ∈ as := by
  simp [Array.mem_iff_getElem]
  grind
            ...
            if name_mem : name ∈ map then
              aux map next.pop
                ...
                (by
                  ...
                  simp only [Array.mem_pop_ne e next_size_pos] at inv2
                  grind)
            else
              ...
              aux (map.insert name d) (next.pop ++ d.imports)
                ...
                (by
                  ...
                  if n_eq : name = n then
                    ...
                    intro i lt
                    have mem := Array.mem_pop_ne (map[n].imports[i]) next_size_pos
                    grind)
