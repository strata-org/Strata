...
// support this for convenience. To parse SMT files that are generated by tools
// relying on this convenience, *_neg categories are added.
// These categories must not be used when printing negative numbers, however.
// It is becauase negative integers like '-1231' are symbols in Std! (Sec 3.1. Lexicon)
