...
-- Generate the Op abbreviations (e.g., Op.not for Op.core Op.Core.not)
-- The macro logs the generated abbreviations as info; see StrataTest/DL/SMT/OpTests.lean for verification
#genOpAbbrevs
