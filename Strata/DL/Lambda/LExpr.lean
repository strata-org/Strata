...
def LExpr.all {TypeType: Type} {Identifier : Type} (ty : Option LMonoTy) := @LExpr.quant TypeType Identifier .all ty LExpr.noTrigger
def LExpr.exist {TypeType: Type} {Identifier : Type} (ty : Option LMonoTy) := @LExpr.quant TypeType Identifier .exist ty LExpr.noTrigger
