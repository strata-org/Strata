...
def usage (defaultDir : String := "StrataTestExtra") : String :=
  s!"Usage: lake test [-- [--dir DIR] [MODULE_PREFIX...] [--exclude PREFIX...]]

Run uncached tests under a directory (default: {defaultDir}/).

Options:
  --dir DIR         Directory containing test files (default: {defaultDir})
