...
def builtinSourceLocation (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", ""),
    ("namedSub", Json.mkObj [
...
def mkSourceLocation (file : String) (function : String) (line : String) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", ""),
    ("namedSub", Json.mkObj [
...
def mkIntType (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "signedbv"),
    ("namedSub", Json.mkObj [
...
def mkCharType (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "signedbv"),
    ("namedSub", Json.mkObj [
...
def mkCharConstantType (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "signedbv"),
    ("namedSub", Json.mkObj [
      ("#c_type", Json.mkObj [("id", "char")]),
...
def mkLongType (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "signedbv"),
    ("namedSub", Json.mkObj [
...
def mkPointerType (subType : Json) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "pointer"),
...
def createSymbol (baseName : String) (line : String) (isParameter : Bool) (isStateVar : Bool) (namePrefix : String) (functionName : String) (config : CBMCConfig) (prettyName : String := "") : CBMCSymbol :=
...
def mkConstant (value : String) (base : String) (sourceLocation : Json) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "constant"),
    ("namedSub", Json.mkObj [
...
def mkStringConstant (value : String) (line : String) (functionName : String) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "address_of"),
    ("namedSub", Json.mkObj [
      ("type", Json.mkObj [
...
def mkParameter (baseName : String) (functionName : String) (line : String) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "parameter"),
    ("namedSub", Json.mkObj [
...
def mkAssertParam (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "parameter"),
    ("namedSub", Json.mkObj [
...
def mkStringParam (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "parameter"),
    ("namedSub", Json.mkObj [
...
def mkAssumeParam (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "parameter"),
    ("namedSub", Json.mkObj [
...
def mkSideEffect (statement : String) (line : String) (functionName : String) (effectType : Json) (sub : Array Json) (config : CBMCConfig ) : Json :=
  Json.mkObj [
    ("id", "side_effect"),
    ("namedSub", Json.mkObj [
      ("#source_location", mkSourceLocation config.sourceFile functionName line config),
...
def mkLvalueSymbol (identifier : String) (line : String) (functionName : String) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "symbol"),
    ("namedSub", Json.mkObj [
      ("#lvalue", Json.mkObj [("id", "1")]),
...
def opToOutTypeJson (op: String) (config : CBMCConfig): Json :=
  match op with
  | ">" => boolType
  | "<" => boolType
  | ">=" => boolType
...
def mkBinaryOp (op : String) (line : String) (functionName : String) (left : Json) (right : Json) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", op),
    ("namedSub", Json.mkObj [
      ("#source_location", mkSourceLocation config.sourceFile functionName line config),
...
def createParameterSymbol (baseName : String) (functionName : String) (config : CBMCConfig): CBMCSymbol :=
  createSymbol baseName "1" true true s!"{functionName}::" functionName config

def createLocalSymbol (baseName : String) (functionName : String) (config : CBMCConfig) : CBMCSymbol :=
...
def mkCodeBlock (statement : String) (line : String) (functionName : String) (sub : Array Json) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "code"),
    ("namedSub", Json.mkObj [
      ("#source_location", mkSourceLocation config.sourceFile functionName line config),
...
def mkBuiltinFunction (_funcName : String) (paramTypes : Array Json) (config : CBMCConfig) : Json :=
  Json.mkObj [
    ("id", "code"),
    ("namedSub", Json.mkObj [
