...
public import StrataLaurel.Implementation.UnorderedCore
...
public import StrataLaurel.Implementation.LaurelTypes
import StrataLaurel.Implementation.Grammar.AbstractToConcreteTreeTranslator
import StrataLaurel.Implementation.HeapAnalysis
...
private def placeholderNode : ResolvedNode :=
  .var "$placeholder" { val := .TVoid, source := { file := .file "StrataLaurel/Implementation/Resolution.lean", range := SourceRange.none } }
